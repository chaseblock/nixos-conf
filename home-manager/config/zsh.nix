{ ... }:
{
  programs.zsh = {
    ...
    shellAliases = {
      ...
      ctower-startvnc = "ssh -t ctower-nocontrol -L 9901:localhost:7899 \"systemctl start vncserver@:1999.service && echo Press enter to quit && read\"";
      ctower-stopvnc = "ssh -t ctower-nocontrol systemctl stop vncserver@:1999.service";
